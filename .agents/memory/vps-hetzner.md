...
- La Mini App Telegram ouvre `https://www.guardiola66.com/splash.html` (env `MINIAPP_URL` dans `/root/Aiogram-Welcome-Bot/telegram-bot/.env`), qui charge ensuite `/login` — vérifier `MINIAPP_URL` avant de patcher une page.
